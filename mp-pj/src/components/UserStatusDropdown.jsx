  ...
  return (
    ...
    <div className="relative w-64">
      ...
      <button
        ...
        className="flex w-full items-center justify-between rounded-md border-2 bg-white px-4 py-2 text-left"
      >
      ...
      {isOpen && (
        <div 
          className="absolute z-10 mt-2 w-full origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5"
        >
